...
class Post(models.Model):
    ...
    prev_ref_post = models.ForeignKey('self',null=True,blank=True,related_name='prev_ref')
    next_ref_post = models.ForeignKey('self',null=True,blank=True,related_name='next_ref')
    objects = PostManager()
